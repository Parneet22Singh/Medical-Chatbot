...
#To implement a function that clears the existing database and starts from scratch replace the embed_articles_to_pinecone() function with the following one:
def embed_articles_to_pinecone(articles):
    index = get_index()
